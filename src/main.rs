...
fn main() {
    ...
    let mut s1 = Sphere::new(Vector3::new(-15f64, -30f64, 100f64), 10.);
    let mut s2 = Sphere::new(Vector3::new(60f64, -30f64, 150f64), 10.);
    ...
    p.set_properties(
        ...
        Vector3::new(0.8f64, 0.8f64, 0.8f64),
    );
    ...
    for i in -2..=2 {
        for j in 1..6 {
            for k in -2..=2 {
                lights.add_global(
                    Vector3::new(0.1 * i as f64, -0.1 * j as f64, 0.1 * k as f64),
